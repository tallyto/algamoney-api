...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa)
VALUES ('Compra de decoração para casa', '2023-07-15', '2023-07-15', 150.00, 'Itens comprados em uma loja de decoração', 'DESPESA', 3, 3);
...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa)
VALUES ('Venda de produtos de beleza', '2023-07-22', NULL, 120.00, 'Produtos vendidos através de um canal online', 'RECEITA', 5, 5);
